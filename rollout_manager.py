...
def rollout_worker_fn(args):
    ...
    trajectory = {
        ...
        'terminated': np.array([data['terminated'] for data in trajectory], dtype=np.bool),
        'truncated': np.array([data['terminated'] for data in trajectory], dtype=np.bool),
    ...
    trajectory['terminated'] = torch.tensor(trajectory['terminated'], dtype=torch.bool)
    trajectory['truncated'] = torch.tensor(trajectory['truncated'], dtype=torch.bool)
